...
<table border=1 width=100% >
	<tr >
		...
		<a href="form.php" target="ifa">Config</a>
		<a href="scripts/logs.php" target="ifa">Logs</a>
...
<td width=70%><iframe name=ifa src=blank.php width=100% height=900px frameborder=0></iframe></td>
...
<hr>
<center>Monitor 2017
	<p> Klaudia Czuba & Mateusz Koprucki</p></center>
